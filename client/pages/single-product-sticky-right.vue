                    ...
                    <div class="col-md-12">
                        <div class="breadcrumb-content">
                            <ul class="nav">
                                ...
                                <li>صفحه محصول (با گالری ستونی راست)</li>
                            </ul>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-md-12 col-xl-6 col-lg-6">
                            <div class="single-product-sticky mb-30px">
                                <div class="single-product-slider-wrapper d-flex flex-wrap">
                                    <div class="single-product-slider-item mb-30px">
                                        <a href="#"><img class="img-responsive" src="assets/images/product-image/6.jpg" alt="slider-item-img"></a>
                                    </div>
                                    <div class="single-product-slider-item  mb-30px">
                                        <a href="#"><img class="img-responsive" src="assets/images/product-image/21.jpg" alt="slider-item-img"></a>
                                    </div>
                                    <div class="single-product-slider-item  mb-30px">
                                        <a href="#"><img class="img-responsive" src="assets/images/product-image/22.jpg" alt="slider-item-img"></a>
                                    </div>
                                    <div class="single-product-slider-item ">
                                        <a href="#"><img class="img-responsive" src="assets/images/product-image/19.jpg" alt="slider-item-img"></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-12 col-xl-6 col-lg-6">
                            <div class="product-details-content sticky">
                                ...
                                <div class="pro-details-rating-wrap">
                                    ...
                                    <span class="read-review"><a class="reviews" href="#">مشاهده نظرات (1)</a></span>
                                </div>
                                ...
                                <div class="pro-details-policy">
                                    <ul>
                                        <li><img src="assets/images/icons/policy.png" alt="" /><span>سیاست امنیتی : توضیحات مربوط به این ویژگی</span></li>
                                        <li><img src="assets/images/icons/policy-2.png" alt="" /><span>حمل و نقل : توضیحات مربوط به این ویژگی</span></li>
                                        <li><img src="assets/images/icons/policy-3.png" alt="" /><span>ضمانت مرجوعی : توضیحات مربوط به این ویژگی</span></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                ...
                <div class="container">
                    <div class="description-review-wrapper">
                        <div class="description-review-topbar nav">
                            ...
                            <a class="active" data-bs-toggle="tab" href="#des-details2">جزئیات محصول</a>
                        ...
                        <div class="tab-content description-review-bottom">
                            <div id="des-details2" class="tab-pane active">
                                <div class="product-anotherinfo-wrapper">
                                    <ul>
                                        ...
                                        <li><span>سایر اطلاعات</span>محصول دارای دفترچه راهنما می باشد.</li>
                                    </ul>
                                </div>
                            </div>
                            <div id="des-details1" class="tab-pane">
                                <div class="product-description-wrapper">
                                    ...
                                    <p>
                                        چاپگرها و متون بلکه روزنامه و مجله در ستون و سطرآنچنان که لازم است و برای شرایط فعلی تکنولوژی مورد نیاز و کاربردهای متنوع با هدف بهبود 
                                        ابزارهای کاربردی می باشد کتابهای زیادی در شصت و سه درصد گذشته حال و آینده شناخت فراوان جامعه و متخصصان را می طلبد 
                                        تا با نرم افزارها شناخت بیشتری را برای طراحان رایانه ای علی الخصوص طراحان خلاقی و فرهنگ پیشرو در زبان فارسی ایجاد کرد که تمام و دشواری موجود در ارائه راهکارها می باشد.
                                    </p>
                                </div>
                            </div>
                                        ...
                                        <div class="review-wrapper">
                                            ...
                                            <div class="single-review child-review">
                                                ...
                                                <div class="review-content">
                                                    ...
                                                    <div class="review-bottom">
                                                        <p>لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است چاپگرها و متون بلکه روزنامه و مجله در ستون و سطرآنچنان که لازم است و برای شرایط فعلی تکنولوژی است.</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="rating-form-style form-submit">
                                                                <textarea name="Your Review" placeholder="متن پیام"></textarea>
                        ...
                        <div class="feature-slider-item swiper-slide">
                            <article class="list-product">
                                ...
                                <div class="product-decs">
                                    <a class="inner-link" href="shop-4-column.html"><span>عنوان محصول</span></a>
                                    <h2><NuxtLink to="/single-product" class="product-link">توضیحات مربوط به محصول</NuxtLink></h2>
                                    <div class="rating-product">
                                        <i class="ion-android-star"></i>
                                        <i class="ion-android-star"></i>
                                        <i class="ion-android-star"></i>
